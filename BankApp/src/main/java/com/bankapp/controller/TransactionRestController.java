...
public class TransactionRestController {
    ...
    private static final String INVALID_TRANSACTION =
            "Account information is invalid or transaction has been denied for safety. Please try again.";
    ...
    public ResponseEntity<?> makeTransfer(
            @Valid @RequestBody TransactionInput transactionInput) {
				LOGGER.debug("Triggered TransactionRestController.transactionInput");
